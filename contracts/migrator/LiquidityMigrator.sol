...
import '../periphery/interfaces/IPandaRouter02.sol';
import '../core/interfaces/IPandaPair.sol';
import './BonusToken.sol';

contract LiquidityMigrator {
  IPandaRouter02 public router;
  IPandaPair public pair;
  IPandaRouter02 public routerFork;
  IPandaPair public pairFork;
  ...
  constructor(
    ...
    router = IPandaRouter02(_router);
    pair = IPandaPair(_pair); 
    routerFork = IPandaRouter02(_routerFork);
    pairFork = IPandaPair(_pairFork);
